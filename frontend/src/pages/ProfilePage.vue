    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16">
        ...
        <div v-else>
            ...
            <div v-if="activeTab === 'profil'" class="mt-6 max-w-2xl">
                ...
                <!-- Logout -->
                <button @click="handleLogout" class="mt-4 w-full sm:w-auto px-6 py-3 border-2 border-ink-10 text-ink-40 text-sm font-semibold rounded-xl hover:border-ink-60 hover:text-ink-60 dark:hover:border-[#f0eeeb] dark:hover:text-[#f0eeeb] dark:text-[#8a8a8e] transition-all">
                    Keluar dari Akun
                </button>
            </div>
                ...
                <div v-else class="space-y-4">
                    ...
                    <div v-for="order in orders" :key="order.id" class="bg-white dark:bg-[#1c1c1e] p-6 rounded-2xl border-2 border-maroon-50 dark:border-[#303032] hover:border-maroon-100 dark:hover:border-slate-600 transition-colors">
                        ...
                        <div v-if="order.payment_method" class="mt-4 pt-4 border-t border-maroon-100 dark:border-[#303032]">
                            ...
                            <!-- Bank Transfer -->
                            <div v-if="order.payment_method === 'bank_transfer'" class="bg-maroon-50/40 dark:bg-[#28282a]/50 rounded-xl p-4 space-y-3">
