    ...
    <div class="max-w-md mx-auto px-4 sm:px-6 py-12 lg:py-24">
        ...
        <form @submit.prevent="handleLogin" class="mt-8 space-y-4">
            ...
            <div>
                ...
                <input v-model="form.password" type="password" required class="w-full border border-aliesmo-200/70 px-4 py-2.5 text-sm text-charcoal placeholder:text-charcoal/30 focus:border-charcoal/50 focus:outline-none transition-colors">
            </div>
        ...
        <p class="mt-6 text-center text-sm text-charcoal/60">
            Belum punya akun?
            <router-link to="/register" class="text-bronze hover:text-charcoal transition-colors font-medium">Daftar</router-link>
        </p>
    </div>
</template>
