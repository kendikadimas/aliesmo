    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div v-else class="space-y-4">
            ...
            <div class="bg-white dark:bg-[#1c1c1e] p-6 lg:p-8 rounded-2xl border-2 border-ink-10 dark:border-[#303032]">
                ...
                <div v-if="order.status === 'pending'" class="mt-4">
                    <button @click="payNow"
                        class="w-full py-3 bg-maroon text-white text-sm font-semibold rounded-xl hover:bg-maroon-600 dark:hover:bg-maroon/80 transition-all active:scale-[0.98] flex items-center justify-center gap-2">
        ...
        <div class="mt-6 text-center">
            <p class="text-xs text-charcoal/40 dark:text-[#6a6a6e]">
                Punya akun?
                <router-link to="/login" class="font-semibold text-maroon dark:text-[#f0eeeb] hover:text-maroon-600 dark:hover:text-[#f0eeeb] transition-colors">Login</router-link>
