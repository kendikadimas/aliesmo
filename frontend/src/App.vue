                ...
                <div class="flex items-center justify-between h-16 lg:h-[72px]">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <router-link to="/" class="flex items-center">
                            <img src="/aliesmo.png" alt="Aliesmo" class="h-10 w-auto transition-all" :class="isDark ? '' : 'invert'" />
                        </router-link>
                    </div>
        ...
        <Transition name="sidebar">
            <aside v-if="mobileOpen" class="lg:hidden fixed top-0 left-0 bottom-0 w-[75vw] max-w-[320px] bg-white dark:bg-[#161618] z-50 shadow-2xl flex flex-col">
                ...
                <div class="flex items-center justify-between px-5 py-4 border-b border-zinc-100 dark:border-[#303032]">
                    <img src="/aliesmo.png" alt="Aliesmo" class="h-10 w-auto" :class="isDark ? '' : 'invert'" />
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                    <div>
                        <div class="flex items-center gap-2">
                            <img src="/aliesmo.png" alt="Aliesmo" class="h-10 w-auto brightness-0 invert" />
                        </div>
