                ...
                <div class="flex items-center justify-between h-20 lg:h-24">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <router-link to="/" class="flex items-center">
                            <img src="/aliesmo.png" alt="Aliesmo" class="w-48 h-auto transition-all" :class="isDark ? '' : 'invert'" />
                        </router-link>
                    </div>
        ...
        <footer class="bg-zinc-800 text-white border-t border-zinc-700">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                    <div>
                        <img src="/aliesmo.png" alt="Aliesmo" class="w-40 h-auto brightness-0 invert" />
