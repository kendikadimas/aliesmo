        ...
        <Transition name="sidebar">
            <aside v-if="mobileOpen" class="lg:hidden fixed top-0 left-0 bottom-0 w-[75vw] max-w-[320px] bg-white dark:bg-[#161618] z-50 shadow-2xl flex flex-col">
                ...
                <nav class="flex-1 overflow-y-auto px-5 py-4 space-y-1">
                    ...
                    <a href="https://wa.me/628138883345?text=Halo%2C%20saya%20ingin%20bergabung%20sebagai%20Affiliate" target="_blank" rel="noopener noreferrer" @click="mobileOpen = false" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-semibold text-charcoal/80 dark:text-[#d0ceca] hover:bg-zinc-50 dark:hover:bg-[#1c1c1e] hover:text-maroon dark:hover:text-[#f0eeeb] transition-colors uppercase tracking-wide">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                    <div>
                        ...
                        <div class="mt-4 flex items-center gap-3">
                            <a v-if="get('social_instagram')?.trim()" :href="get('social_instagram')" target="_blank" rel="noopener noreferrer" class="w-8 h-8 flex items-center justify-center rounded-lg bg-white/10 hover:bg-white/20 transition-colors" aria-label="Instagram">
                            ...
                            <a v-if="get('social_tiktok')?.trim()" :href="get('social_tiktok')" target="_blank" rel="noopener noreferrer" class="w-8 h-8 flex items-center justify-center rounded-lg bg-white/10 hover:bg-white/20 transition-colors" aria-label="TikTok">
                            ...
                            <a v-if="get('social_shopee')?.trim()" :href="get('social_shopee')" target="_blank" rel="noopener noreferrer" class="w-8 h-8 flex items-center justify-center rounded-lg bg-white/10 hover:bg-white/20 transition-colors" aria-label="Shopee">
