...
class BiteshipService
{
    ...
    // Kurir yang didukung Biteship — sesuaikan dengan yang ada di RajaOngkirService
    private const COURIERS = 'jne,jnt,sicepat,anteraja,tiki,pos,ninja,lion,wahana,sap,ide';
