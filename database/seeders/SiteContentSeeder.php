    ...
    public function run(): void
    {
        ...
        $general = [
            ...
            [
                ...
                'label' => 'Instagram',
                'value' => 'https://www.instagram.com/aliesmo.id?igsh=MWVxMGl3dnZrODA0Yg%3D%3D&utm_source=qr',
                'type'  => 'text',
                'group' => 'general',
            ],
            [
                'key'   => 'social_tiktok',
                'label' => 'TikTok',
                'value' => 'https://www.tiktok.com/@aliesmo_?_r=1&_t=ZS-980yYZZtxQn',
                'type'  => 'text',
                'group' => 'general',
            ],
            [
                'key'   => 'social_shopee',
                'label' => 'Shopee',
                'value' => 'https://shopee.co.id/aliesmo.id',
                'type'  => 'text',
                'group' => 'general',
            ],
            [
