<template>
    <div class="max-w-md mx-auto px-4 sm:px-6 py-12 lg:py-24">
        <h1 class="text-2xl sm:text-3xl font-bold text-charcoal text-center tracking-tight">Masuk</h1>
        <p class="mt-2 text-center text-sm text-charcoal/60">Masuk ke akun Aliesmo kamu</p>
        ...
        <div class="flex items-center gap-3 my-5">
            ...
            <span class="text-xs text-charcoal/40 font-medium">atau</span>
            <div class="flex-1 h-px bg-maroon-100"></div>
        </div>
        ...
        <form @submit.prevent="handleLogin" class="space-y-4">
            ...
            <div>
                ...
                <input v-model="form.password" type="password" required placeholder="••••••••" class="w-full border-2 border-maroon-100 rounded-xl px-4 py-2.5 text-sm text-charcoal placeholder:text-charcoal/30 bg-white focus:border-maroon focus:outline-none transition-colors">
            </div>
        ...
        <p class="mt-6 text-center text-sm text-charcoal/60">
            Belum punya akun?
            <router-link to="/register" class="text-maroon hover:text-maroon-600 font-semibold underline underline-offset-2">Daftar</router-link>
        </p>
    </div>
</template>
