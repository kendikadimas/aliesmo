<template>
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16">
        ...
        <div v-else>
            ...
            <h1 class="mt-5 text-2xl lg:text-3xl font-bold text-charcoal tracking-tight text-center">Pesanan Berhasil!</h1>
            <p class="mt-2 text-sm text-charcoal/60 text-center">Terima kasih, <strong>{{ order.customer_name }}</strong>. Pesanan Anda telah tercatat.</p>

            <div class="mt-4 flex flex-col items-center gap-2">
                <div class="inline-flex items-center gap-2 px-4 py-2 bg-maroon-50 border-2 border-maroon-100 rounded-lg text-sm text-charcoal/70">
                    <span class="text-[10px] font-bold text-charcoal/50 uppercase tracking-wide">No. Pesanan:</span>
                    <span class="font-bold tracking-wider text-charcoal">{{ order.order_number }}</span>
                </div>
...
const waNumber = ref('6281234567890')
